...
- [ ] Тест для SGP4 — отключён (баг в парсинге TLE: indices/spaces mismatch)
- [ ] Тест для LittleFS
- [ ] Тест для OTA Updater

### Статус на 11 апреля 2026 (01:15)
- **Ветка:** dev (a78968d) ✅
- **Сборка:** ✅ без ошибок
- **Тесты:** ✅ 14/14 (100%)
- **Критических багов:** 0 ✅
- **Известные проблемы:**
  - ⚠️ SGP4 TLE парсер — требует доработки (ошибка в индексах/пробелах)
