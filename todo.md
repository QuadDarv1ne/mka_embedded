...
|---------|---------|--------------|-----------|
| Покрытие тестами | ~65% | 70% | 90% |
| Драйверов | 8 | 10 | 20 |
| Строк кода C++ | ~10000 | 15000 | 30000 |
...
*Последнее обновление: 26 марта 2026 (v1.1.0 выполнена, подготовка к v1.2.0)*
