...
- [x] Parameter Store ✅
  ...
  - [ ] Приоритеты каналов
- [ ] Обработчик команд
  - [ ] Валидация команд (CRC, таймстемп)
  - [ ] Очереди команд
...
- [ ] GitHub Actions для:
  - [ ] Сборки (Linux, Windows, macOS)
  - [ ] Юнит-тестов
  - [ ] Статического анализа (cppcheck, clang-tidy)
  - [ ] Генерации документации
  - [ ] Проверки форматирования (clang-format)
...
|---------|---------|--------------|-----------|
| Покрытие тестами | ~40% | 70% | 90% |
| Драйверов | 4 | 10 | 20 |
| Строк кода C++ | ~5000 | 15000 | 30000 |
...
### Milestone 1: v1.1.0 (Апрель 2026)
- [ ] LSM6DSO драйвер
- [ ] BMP388 драйвер
- [ ] Telelemetry generator
- [ ] Command handler
- [ ] 10 примеров кода
