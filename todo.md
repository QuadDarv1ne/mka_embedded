...
- [x] 4 дополнительных примера кода ✅
  ...
  - [x] `07_fdir_demo` — мониторинг параметров ✅
- [ ] 3 дополнительных примера кода — **ПЕРЕНЕСЕНО В v1.5.0**
  - [ ] `08_sd_card_logger` — запись на SD карту
  - [ ] `09_low_power_mode` — режимы энергосбережения
  - [ ] `10_can_comm` — CAN коммуникация
...
- 📊 Файлов C++: **44**
- 📊 Файлов Python: **12**
- 📊 Строк кода C++: **~675K** (с учётом всех файлов)
- 📊 Юнит-тестов: **15** (включая test_freertos_wrapper)
- 📊 Примеров кода: **7** (01_blinky, 02_uart_echo, 03_i2c_scan, 04_imu_reader, 05_gps_logger, 06_freeRTOS_tasks, 07_fdir_demo)
- 📊 Скриптов автоматизации: **6** (setup, install_ninja, launch, port_checker)
- 📊 Покрытие тестами: **~70%**

**Технический долг (требует внимания):**
- ⚠️ **Примеры кода** — 3 из 10 осталось (sd_card_logger, low_power_mode, can_comm)
