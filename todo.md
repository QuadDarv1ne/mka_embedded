...
- [ ] Добавить sgp4.cpp, anomaly_detector.cpp в CMakeLists.txt
...
*Последнее обновление: 5 апреля 2026 (v2.0.0-dev — CMake улучшения, подготовка к релизу)*

---

## 🔄 Актуальный статус (5 апреля 2026)
...
**Выполнено в v2.0.0-dev (5 апреля 2026):**
...
- [ ] CANopen стек (полная реализация)
