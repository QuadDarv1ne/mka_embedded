...
- [ ] `sd_card_logger` — запись на SD карту
- [ ] `low_power_mode` — режимы энергосбережения
- [ ] `can_comm` — CAN коммуникация
...
### Milestone 4: v1.4.0 (Апрель 2026) — ТЕКУЩАЯ
- [ ] FreeRTOS wrapper (задачи, очереди, семафоры, мьютексы)
- [ ] Mock HAL для тестирования
- [ ] 7 дополнительных примеров кода
- [ ] CANopen стек (базовая реализация)
- [ ] PD контроллер ориентации (улучшенный)

### Milestone 5: v2.0.0 (Декабрь 2026)
...
- ✅ **FreeRTOS wrapper** — в разработке (v1.4.0)
- ✅ **Mock HAL** — в разработке (v1.4.0)
...
*Последнее обновление: 1 апреля 2026 (v1.4.0-dev — FreeRTOS wrapper + Mock HAL)*

---

## 🔄 Актуальный статус (01.04.2026)

### Текущая версия: v1.4.0-dev 🚧 В РАЗРАБОТКЕ

**Статус веток:**
- `main` ✅ — v1.3.0 (EKF + 24 теста + I2C + 3 примера)
- `dev` 🚧 — v1.4.0-dev (FreeRTOS wrapper + Mock HAL)
...
- ✅ Все тесты проходят (14 тестов, 100%)
- ✅ Метрики обновлены: покрытие ~70%, строк кода ~15000
...
**В работе v1.4.0:**
- 🚧 FreeRTOS wrapper — обёртки над задачами, очередями, семафорами
...
- Приоритет: FreeRTOS wrapper + Mock HAL
- 7 дополнительных примеров кода
- CANopen стек (базовая реализация)
